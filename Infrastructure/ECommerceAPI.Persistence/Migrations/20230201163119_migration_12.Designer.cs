...
namespace ECommerceAPI.Persistence.Migrations
{
    ...
    [Migration("20230201163119_migration_12")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceAPI.Domain.Entities.Endpoint", b =>
                {
                    ...
                    b.Property<Guid>("MenuEndpointId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("MenuEndpointId");

                    b.ToTable("Endpoints");
                });

            modelBuilder.Entity("ECommerceAPI.Domain.Entities.Files.File", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ECommerceAPI.Domain.Entities.Identity.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("ECommerceAPI.Domain.Entities.Identity.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ECommerceAPI.Domain.Entities.MenuEndpoint", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ECommerceAPI.Domain.Entities.Files.InvoiceFile", b =>
                {
                    b.HasBaseType("ECommerceAPI.Domain.Entities.Files.File");
            ...
            modelBuilder.Entity("ECommerceAPI.Domain.Entities.Files.ProductImageFile", b =>
                {
                    b.HasBaseType("ECommerceAPI.Domain.Entities.Files.File");
            ...
            modelBuilder.Entity("ApplicationRoleEndpoint", b =>
                {
                    b.HasOne("ECommerceAPI.Domain.Entities.Identity.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ECommerceAPI.Domain.Entities.Basket", b =>
                {
                    b.HasOne("ECommerceAPI.Domain.Entities.Identity.ApplicationUser", "ApplicationUser")
                        .WithMany("Baskets")
            ...
            modelBuilder.Entity("ECommerceAPI.Domain.Entities.Endpoint", b =>
                {
                    b.HasOne("ECommerceAPI.Domain.Entities.MenuEndpoint", "MenuEndpoint")
                        .WithMany("Endpoints")
                        .HasForeignKey("MenuEndpointId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("MenuEndpoint");
                });
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ECommerceAPI.Domain.Entities.Identity.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("ProductProductImageFile", b =>
                {
                    b.HasOne("ECommerceAPI.Domain.Entities.Files.ProductImageFile", null)
                        .WithMany()
